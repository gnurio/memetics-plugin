...
name: craft-content
description: >
  Create optimized viral content variants from a core idea. Takes a message and produces
  2-5 shareable content pieces using proven memetic tactics: villain narratives, emotional
  activation, lightweight format, niche targeting. Output is ready-to-post content with
