...
name: build-immunity
description: >
  Design and implement tactics to strengthen a network's resistance to unwanted memes
  and supermeme traps. Standalone defensive skill for teams, organizations, or networks
  wanting to build critical thinking and memetic resilience.

  [NEEDS SOURCE MATERIAL] Source describes immunity-building goal but doesn't detail
  the full implementation methodology, frequency, or specific frameworks to teach.
---
...
3. "What evidence would prove this wrong?"
4. "What's the narrative/story here?"
5. "What emotion is it activating?"
6. "Is this asking me to act or just feel?"
...
- [ ] Teach three core frameworks
- [ ] Start monthly critical analysis sessions
- [ ] Introduce diverse speakers/reading
...
- [ ] Build shared critical vocabulary
- [ ] Measure changes in receptivity

### Month 7-12: Integration
- [ ] Critical thinking becomes normal
- [ ] People applying frameworks independently
- [ ] Diversity is explicit value
- [ ] Outside connections normalized

### 1+ Years: Maintenance
- [ ] Ongoing practice
- [ ] Rotating new diverse perspectives
